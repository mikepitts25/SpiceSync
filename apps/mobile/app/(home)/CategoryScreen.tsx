...
const tiles: Array<{ tier: Tier; title: string; desc: string; bg: string }> = [
  {
    tier: 'romance',
    title: 'Romance',
    desc: 'Affectionate, cozy, intimacy-building ideas.',
    bg: '#1f2435',
  },
  {
    tier: 'soft',
    title: 'Soft Kinks',
    desc: 'Light, playful, PG-13 kink exploration.',
    bg: '#2a2638',
  },
  {
    tier: 'naughty',
    title: 'Naughty Kinks',
    desc: 'Adult themes; still non-graphic & consent-first.',
    bg: '#35243c',
  },
  {
    tier: 'xxx',
    title: 'XXX Kinks',
    desc: 'Explicit topics described neutrally; no graphic detail.',
    bg: '#3c2430',
  },
];
