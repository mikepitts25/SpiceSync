...
export default function AboutScreen() {
  return (
    <View style={{ flex:1, backgroundColor:'#0B0B0E', padding:16, paddingTop:48 }}>
      ...
      <Text style={{ color:'#C8C8D0', marginBottom:8 }}>Nothing involving minors, coercion, animals, degradation, self-harm, illegal activity, or explicit content is allowed.</Text>
