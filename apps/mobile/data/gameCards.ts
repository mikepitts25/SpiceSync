...
export const FREE_CARDS: GameCard[] = [
  ...
  { id: 'f-t5', type: 'truth', content: "Tell me exactly how you want to be kissed right now.", intensity: 2, category: 'intimate', isPremium: false, estimatedTime: 'N/A' },
  { id: 'f-d1', type: 'dare', content: "Kiss me somewhere unexpected—not my lips.", intensity: 2, category: 'physical', isPremium: false, estimatedTime: 'N/A' },
