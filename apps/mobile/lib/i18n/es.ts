...
export const es: Translations = {
  ...
  // Misiones de Match
  matchMissions: {
    title: 'Misiones de Match',
    subtitle: 'Misiones pequeñas y opcionales de lo que ya hicieron match.',
    emptyTitle: 'Aún no hay matches mutuos',
    emptyBody:
      'Las Misiones de Match convierten cosas en las que ambos dijeron que sí en una misión pequeña y opcional. Voten juntos algunos intereses para desbloquear la primera.',
    emptyCta: 'Explorar intereses',
    noPartnerTitle: 'Conecta con tu pareja',
    noPartnerBody:
      'Las Misiones de Match necesitan un perfil de pareja vinculado para encontrar en qué hicieron match.',
  ...
  knowMeBetter: {
    ...
    yourGuess: 'Ahora, la adivinanza de {{name}}',
    reveal: 'Revelar',
    matchTitle: '¡Es un match!',
    matchBody: 'Se conocen muy bien.',
    missTitle: 'Respuestas diferentes — ¡bueno saberlo!',
    ...
    summaryClosing:
      'Cada ronda — con match o sin él — es un poco más el uno del otro.',
  ...
  coupleDice: {
    ...
    subtitle: 'Tira los dados para un prompt juguetón y consensuado.',
    intensityLabel: 'Intensidad',
    roll: 'Tirar',
    rollAgain: 'Tirar otra vez',
    saveForLater: 'Guardar para después',
    skip: 'Saltar',
    safetyNote: 'Siempre puedes cambiar el prompt o saltarlo.',
    savedTitle: 'Prompts guardados',
    savedEmpty: 'Los prompts que guardes aparecerán aquí.',
    delete: 'Eliminar',
    moodLabel: 'Ánimo',
    actionLabel: 'Acción',
    momentLabel: 'Momento',
