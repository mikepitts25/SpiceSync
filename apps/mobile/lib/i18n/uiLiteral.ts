...
const supplementalSpanish: Record<string, string> = {
  ...
  "You can remove local profiles, votes, and preferences with SpiceSync's reset controls or by uninstalling the app. Account deletion removes your permanent account and revokes its account-associated device and couple metadata. Unlinking a partner revokes the connection, but clearing or uninstalling the app does not automatically delete relay records. Contact us through the App Store listing if you need help with relay data.":
    'Puedes eliminar perfiles, votos y preferencias locales con los controles de restablecimiento de SpiceSync o desinstalando la app. La eliminación de la cuenta elimina tu cuenta permanente y revoca los metadatos de dispositivos y de pareja asociados a ella. Desvincular una pareja revoca la conexión, pero borrar o desinstalar la app no elimina automáticamente los registros del servicio de retransmisión. Contáctanos mediante la ficha de App Store si necesitas ayuda con esos datos.',
