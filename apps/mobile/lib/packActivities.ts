...
export const VACATION_CARDS: GameCard[] = [
  // TRUTH
  { id: 'vac-t1', type: 'truth', content: "What's the wildest place you'd want me on vacation? Be specific.", intensity: 3, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'vac-t2', type: 'truth', content: "Have you ever fantasized about joining the mile high club? With me?", intensity: 4, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'vac-t3', type: 'truth', content: "What's the most adventurous place you've ever done it? Would you go further with me?", intensity: 4, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'vac-t4', type: 'truth', content: "If we had a hotel room with a balcony overlooking the ocean—what would you want to do?", intensity: 4, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  ...
  // FANTASY
  { id: 'vac-fn1', type: 'fantasy', content: "Describe our ideal vacation hookup scenario. Location, build-up, and what happens.", intensity: 4, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'vac-fn2', type: 'fantasy', content: "Tell me about a travel fantasy involving us and a stranger or another couple.", intensity: 4, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
];
...
export const KINKY201_CARDS: GameCard[] = [
  // TRUTH
  { id: 'k201-t1', type: 'truth', content: "What's a kink you've been curious about but never tried? Would you try it with me?", intensity: 4, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'k201-t2', type: 'truth', content: "How do you feel about light bondage? Being tied up or doing the tying?", intensity: 4, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'k201-t3', type: 'truth', content: "What's something 'taboo' that secretly turns you on? No judgment.", intensity: 5, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'k201-t4', type: 'truth', content: "Have you ever wanted to be completely dominated? Or to dominate me? Tell me the fantasy.", intensity: 5, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'k201-t5', type: 'truth', content: "What's the most intense pain-to-pleasure ratio you'd be willing to explore?", intensity: 5, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  ...
  { id: 'k201-d6', type: 'dare', content: "Choke and kiss: Light pressure on my neck while you kiss me deeply. Control my breath.", intensity: 5, category: 'intimate', isPremium: true, estimatedTime: '1 min' },
  ...
  // FANTASY
  { id: 'k201-fn1', type: 'fantasy', content: "Describe your darkest fantasy you want to try with me. Don't hold back.", intensity: 5, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
  { id: 'k201-fn2', type: 'fantasy', content: "Tell me about a CNC (consensual non-consent) scenario you'd want to explore. Safewords required.", intensity: 5, category: 'intimate', isPremium: true, estimatedTime: '30 sec' },
];
...
export const DATENIGHT_CARDS: GameCard[] = [
  // TRUTH
  { id: 'dn-t1', type: 'truth', content: "What's one thing I do that makes you feel truly loved? Not just attracted—loved.", intensity: 2, category: 'emotional', isPremium: true, estimatedTime: '30 sec' },
  { id: 'dn-t2', type: 'truth', content: "When did you first realize you were falling for me? Tell me the moment.", intensity: 2, category: 'emotional', isPremium: true, estimatedTime: '30 sec' },
  { id: 'dn-t3', type: 'truth', content: "What's a memory of us that always makes you smile, no matter what?", intensity: 2, category: 'emotional', isPremium: true, estimatedTime: '30 sec' },
  { id: 'dn-t4', type: 'truth', content: "How do you want to be held when you're feeling vulnerable? Show me.", intensity: 2, category: 'emotional', isPremium: true, estimatedTime: '30 sec' },
  { id: 'dn-t5', type: 'truth', content: "What's something you appreciate about me that you've never said out loud?", intensity: 2, category: 'emotional', isPremium: true, estimatedTime: '30 sec' },
  ...
  // FANTASY
  { id: 'dn-fn1', type: 'fantasy', content: "Describe our perfect anniversary night 10 years from now. Where are we? What are we doing?", intensity: 2, category: 'emotional', isPremium: true, estimatedTime: '30 sec' },
  { id: 'dn-fn2', type: 'fantasy', content: "Tell me about growing old together. What do you see? What do you hope never changes?", intensity: 2, category: 'emotional', isPremium: true, estimatedTime: '30 sec' },
];
