...
export default function PaywallModal() {
  ...
  const feature = paywallFeature
    ? FEATURES.find((f) => f.id === paywallFeature)
    : null;
      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        >
          ...
          <View style={styles.pricingHighlight}>
            ...
            <Text style={styles.priceNote}>
              One-time unlock • All features • All packs
            </Text>
          </View>
          ...
          <View style={styles.packsSection}>
            ...
            <Text style={styles.packsSubtitle}>
              À la carte options at {formatPrice(PRICING.PACK_PRICE)} each
            </Text>
            ...
            <View style={styles.packsGrid}>
              {PACKS.map((pack) => (
                <View
                  key={pack.id}
                  style={[styles.packItem, { borderColor: pack.color }]}
                >
        ...
        >
          <Pressable style={styles.ctaButton} onPress={handleUpgrade}>
            <Text style={styles.ctaText}>See All Options</Text>
          </Pressable>
