// scripts/build-kinks-v4.js
// Clear, recognizable titles with playful descriptions
...
// ============ GROUP ============
all.push(
  single("threesome-mmf", "MMF Threesome", "Two men focused entirely on her pleasure. Multiple hands, multiple mouths, being the absolute center of attention.", ["group"], "group", 3, "xxx"),
  single("threesome-mff", "MFF Threesome", "Two women sharing him. Taking turns, working together, making him feel like a king.", ["group"], "group", 3, "xxx"),
  single("cuckold-him", "Cuckolding (Him Watching)", "He sits in the corner while she takes another man. The humiliation, the arousal, the reclaiming after.", ["cuckold"], "group", 3, "xxx"),
  single("cuckold-her", "Cuckolding (Her Watching)", "She watches him with another woman. Deciding if he deserves to come, directing the action, owning his pleasure.", ["cuckold"], "group", 3, "xxx"),
  single("hotwife", "Hotwife Dynamic", "She goes out, has her fun, comes home full of details. He reclaims her, tastes the evidence, owns her again.", ["hotwife"], "group", 3, "xxx"),
...
// ============ FETISH ============
all.push(
  single("foot-worship", "Foot Worship", "Kiss, lick, massage her feet. Admire them. Some find feet incredibly erotic. Worship accordingly.", ["feet"], "roleplay", 2, "naughty"),
...
console.log("=== KINKS V4 GENERATED ===");
console.log({
  ...
  samplePairs: numbered.filter(k => k.slug.includes("-give") || k.slug.includes("-receive")).slice(0, 6).map(k => ({slug: k.slug, title: k.title}))
});
