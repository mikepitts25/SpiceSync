/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76efc6fddc4ea225ef63fad99bd0cf4a)
...
interface __BaseEnv_Env {
	...
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").DeletionRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeletionRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTREAM_URL">> {}
}
